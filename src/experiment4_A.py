...
if __name__ == "__main__":
    ...
    insurers = []
    insurers.append(RiskAware(A=0, K=K, risk_measure=TVaR(kappa=0.95, prior=prior), capital=capital))
    ...
    insurers.append(RiskAware(A=1e4, K=K, risk_measure=TVaR(kappa=0.95, prior=prior), capital=capital))
